...
class LabelTool():
    def __init__(self, master):
        ...
        self.list_box_new = Listbox(self.frame, width=22, height=12)
        ...
        self.owlValue.pack(side=LEFT)
        self.increaseBtn = Button(self.ctrPanel, text="+", command=self.increase)
        self.increaseBtn.pack(side=LEFT)
    ...
    def increase(self, event=None):
        value = int(self.owlValue["text"])
        self.owlValue["text"] = f"{value + 1}"
